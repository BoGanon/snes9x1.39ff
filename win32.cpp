...
bool S9xGetState (WORD KeyIdent)
{
	if (KeyIdent & 0x8000)
	{
		...
		{
			case 0:
				return !Joystick [j].Left;
			case 1:
				return !Joystick [j].Right;
			case 2:
				return !Joystick [j].Up;
			case 3:
				return !Joystick [j].Down;
			case 4:
				return !Joystick [j].PovLeft;
			case 5:
				return !Joystick [j].PovRight;
			case 6:
				return !Joystick [j].PovUp;
			case 7:
				return !Joystick [j].PovDown;
			case 41:
				return !Joystick [j].ZUp;
			case 42:
				return !Joystick [j].ZDown;
			case 43:
				return !Joystick [j].RUp;
			case 44:
				return !Joystick [j].RDown;
			case 45:
				return !Joystick [j].UUp;
			case 46:
				return !Joystick [j].UDown;
			case 47:
				return !Joystick [j].VUp;
			case 48:
				return !Joystick [j].VDown;
...
void S9xSetWinPixelFormat ()
{
	...
	else
	{
		...
		else if( (DirectX.DDPixelFormat.dwFlags&DDPF_RGB) != 0 &&
		         GUI.ScreenDepth == 16 &&
		...
		else if (DirectX.DDPixelFormat.dwRGBBitCount == 8 ||
